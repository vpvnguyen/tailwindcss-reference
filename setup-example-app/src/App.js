...
const Nav = ({ children }) => (
  <>
    <nav className="p-8 text-center bg-green-500">
      <a className="p-4 text-xl font-bold border-solid" href="/sandbox">
        Sandbox
      </a>
      <a className="p-8 text-xl font-bold border-solid" href="/ui">
        Tailwind UI
      </a>
      <a className="p-4 text-xl font-bold border-solid" href="/dashboard">
        Dashboard
      </a>
      <a className="p-4 text-xl font-bold border-solid" href="/ui">
        Responsive Design
      </a>
    </nav>
